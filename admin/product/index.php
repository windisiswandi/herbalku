...
<body>
            ...
            <div class="form_isi_tp_adm">
                ...
                <div class="box_form_isi_tp_adm2">
                    ...
                    <select class="input" id="kategori_tp">
                        ...
                        ?>
                        <option value="<?php echo $kategori_pro_data['id']; ?>">
                            <?php echo $kategori_pro_data['nama']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
                ...
                <div class="box_form_isi_tp_adm2">
                    <input type="text" class="input currency" data-separator="." id="berat_tp"
                        placeholder="Berat Barang Satuan Gram">
                ...
                <div class="box_form_isi_tp_adm5">
                    ...
                    <div class="box_img_produk_tambah">
                        <div class="isi_box_img_produk_tambah" id="isi_box_img_produk_tambah<?php echo $w_tp_img; ?>"
                            onclick="click_img()">
                            <i class="ri-image-add-line" id="icon_tp_<?php echo $w_tp_img; ?>"></i>
                            <img src="" id="show_img_tp_<?php echo $w_tp_img; ?>">
                        </div>
                        <input type="file" class="ci_tp" id="c_img_tp_<?php echo $w_tp_img; ?>"
                            onchange="preview_image(event, '<?php echo $w_tp_img; ?>')">
                    </div>
                    <?php
                    }
                    ?>
    ...
    <div class="back_popup_confirm" id="popup_hapus_produk">
        <div class="popup_confirm">
            ...
            <h5>Produk yang sudah di hapus tidak akan di tampilkan dan dapat dipulihkan kembali, apakah anda yakin ingin
                manghapus produk ini?</h5>
    ...
    <div class="back_tp_adm" id="back_ep_adm">
        <div class="isi_tp_adm">
            ...
            <div class="form_isi_tp_adm">
                ...
                <div class="box_form_isi_tp_adm2">
                    <input type="text" class="input currency" data-separator="." id="berat_ep"
                        placeholder="Berat Barang Satuan Gram">
                ...
                <div class="box_form_isi_tp_adm5">
                    ...
                    ?>
                    <div class="box_img_produk_tambah">
                        <div class="isi_box_img_produk_tambah" id="isi_box_img_produk_tambah_ep<?php echo $w_tp_img; ?>"
                            onclick="click_img_ep('<?php echo $w_tp_img; ?>')">
                            <i class="ri-image-add-line" id="icon_ep_<?php echo $w_tp_img; ?>"></i>
                            <img src="" id="show_img_ep_<?php echo $w_tp_img; ?>">
                        </div>
                        <input type="file" class="ci_tp" id="c_img_ep_<?php echo $w_tp_img; ?>"
                            onchange="preview_image_ep(event, '<?php echo $w_tp_img; ?>')">
                ...
                <div class="box_varian_produk_adm">
                    ...
                    <div class="varian_produk_adm">
                        ...
                        ?>
                        <div class="isi_varian_produk_adm v_warna_adm"
                            id="box_v_warna_adm_ep<?php echo $v_warna_adm_ep; ?>">
                            <input type="text" class="input" id="v_warna_adm_ep<?php echo $v_warna_adm_ep; ?>"
                                placeholder="Warna...">
                        </div>
                        <?php
                        }
                        ?>
                        <div class="isi_varian_produk_adm" id="box_add_warna_varian_adm_ep"
                            onclick="add_warna_varian_ep()">
                            <div class="add_warna_varian_adm">
                                <span>Tambah</span>
                            </div>
                        </div>
                ...
                <div class="box_varian_produk_adm">
                    <h5>Varian Ukuran</h5>
                    <p>Contoh Ukuran: botol atau tablet </p>
                    <div class="varian_produk_adm2">
                        <?php
                        for ($v_ukuran_adm_ep = 1; $v_ukuran_adm_ep <= 10; $v_ukuran_adm_ep++) {
                        ?>
                        <div class="isi_varian_produk_adm2 v_warna_adm"
                            id="box_v_ukuran_adm_ep<?php echo $v_ukuran_adm_ep; ?>">
                            <input type="text" class="input" id="v_ukuran_adm_ep<?php echo $v_ukuran_adm_ep; ?>"
                                placeholder="Ukuran...">
                            <input type="number" class="input" id="v_ukuran_harga_adm_ep<?php echo $v_ukuran_adm_ep; ?>"
                                placeholder="Harga...">
                        </div>
                        <?php
                        }
                        ?>
                        <div class="isi_varian_produk_adm" id="box_add_ukuran_varian_adm_ep"
                            onclick="add_ukuran_varian_ep()">
                            <div class="add_warna_varian_adm">
                                <span>Tambah</span>
                            </div>
                        </div>
                ...
                <div class="list_produk_n">
                    ...
                    <div class="isi_all_users_admin">
                        ...
                        show_edit_produk<?php echo $list_produk_adm['id']; ?>.onclick = function() {
                            ...
                            document.getElementById(add_show_img_ep).src =
                                '../../assets/image/product/<?php echo $exp_gambar_lp[$key_gambar_ep]; ?>';
                            document.getElementById(add_val_img_ed_ep).value =
                                '<?php echo $exp_gambar_lp[$key_gambar_ep]; ?>';
                            <?php
                                    }
                            ...
                            v_warna_adm_ep<?php echo $lop_jw_ep; ?>.value =
                                '<?php echo $exp_warna_adm_ep[$key_arr_warna_ep]; ?>';
                            <?php
                                        }
                                    }
                            ...
                            v_ukuran_harga_adm_ep<?php echo $lop_ju_ep; ?>.value =
                                '<?php echo $exp_har_uk_ep[1]; ?>';
                            <?php
                                        }
                                    }
                                    ?>
