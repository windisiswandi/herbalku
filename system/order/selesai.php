...
$select_invoice = $server->query("SELECT * FROM invoice WHERE id_user=$iduser and tipe_progress='Selesai' ORDER BY idinvoice DESC");
            ...
            <div class="isi_cart" id="isi_cart<?php echo $invoice_data['idinvoice']; ?>">
                ...
                <div class="box_detail_isi_cart">
                    <div class="box_total_harga">
                        <p>Pesanan Selesai</p>
                        <h1><?php echo $invoice_data['waktu_selesai']; ?></h1>
                    </div>
