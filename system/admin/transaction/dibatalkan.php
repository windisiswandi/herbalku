...
$select_invoice = $server->query("SELECT * FROM `akun`, `invoice` WHERE invoice.tipe_progress='Dibatalkan' AND invoice.id_user=akun.id ORDER BY `invoice`.`idinvoice` DESC");
