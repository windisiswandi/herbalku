...
// NOTIF EMAIL
$select_user_mp = $server->query("SELECT * FROM `invoice`, `akun` WHERE invoice.idinvoice='$idinvoicesb' AND invoice.id_user=akun.id ");
...
<p style='font-size: 16px; margin-top: 10px;'>Produk <span style='font-weight: bold;'>Anda</span> Telah Sampai Ke Tujuan.</p>
</div>";
